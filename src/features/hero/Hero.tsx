      ...
      >
        ...
        >
          ...
          <span
            aria-live="polite"
            aria-atomic="true"
            className="relative inline-flex items-end align-bottom overflow-hidden h-[1.3em] pb-[0.05em] min-w-[5ch]"
          >
            <AnimatePresence mode="wait" initial={false}>
              <motion.span
                ...
                className="inline-flex items-end h-[1.3em] whitespace-nowrap leading-none text-yellow"
              >
                {word}
              </motion.span>
            </AnimatePresence>
